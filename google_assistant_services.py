...
class GAActionHandler(RequestHandler):
    ...
    def post(self):
        ...
        print (data)
        if 'queryResult' in data and 'parameters' in data['queryResult'] and data['queryResult']['parameters']['command']:
            queryResult = data['queryResult']
            command = queryResult['parameters']['command']
            userid = data['originalDetectIntentRequest']['payload']['user']['userId']
        elif "inputs" in data and "arguments" in data["inputs"] and "rawText" in data["inputs"]["arguments"]:
            command = data["inputs"]["arguments"]["rawText"]
